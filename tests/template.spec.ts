...
// [Arrange] ==> Contains the variables, constants, and methods that are used in the test
// [Act]
// [Assert]

const password = process.env.PASSWORD; // Variables

test.beforeAll(async ({ playwright }) => { // Method to run before all tests in the field
    test.skip( // condition
      !!process.env.PROD,
